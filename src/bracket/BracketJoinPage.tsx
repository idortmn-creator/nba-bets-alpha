...
import { joinBracketLeague } from './bracketLeague.service'

export default function BracketJoinPage() {
  ...
  async function handleJoin() {
    ...
    try {
      const lid = await joinBracketLeague(code, currentUser, currentUserDoc)
      toast('✅ הצטרפת לליגת ברקט!')
      navigate(`/bracket/league/${lid}`)
    } catch (e: unknown) {
  ...
  return (
    <div className="py-6">
      <div className="mb-4 flex items-center justify-between">
        <div className="text-lg font-bold">🔗 הצטרף לליגת ברקט</div>
